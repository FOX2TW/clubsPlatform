...
import {Club, ClubDetail} from "./model/clubs";
import {connect} from "@tarojs/redux";
import {editClub} from "./store/actions/clubs.action";
  ...
  render() {
    return (
      <View className='users-container'>
        ...
        <AtButton type='primary' customStyle='margin-top: 10px;' onClick={()=>this.edit()}>提交</AtButton>
      </View>
    )
  }
}
